...
이번 단계 목적은 실제 Zoom 회의 `10000000001` 에서 입장/퇴장 이벤트가 도착하는지 실측하는 것이다.
...
- 두 이벤트 모두 `meeting_id=10000000001` 으로 들어왔다.
...
2026-04-04 기준 새 Zoom 앱과 새 회의 ID `10000000001` 에서 webhook 실측은 성공했다.
